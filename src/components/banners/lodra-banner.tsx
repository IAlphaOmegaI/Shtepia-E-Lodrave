...
const LodraBanner = () => {
  return (
    <div className="relative flex min-h-[510px] sm:min-h-[550px] md:min-h-[580px] lg:min-h-[620px] xl:min-h-[680px] overflow-hidden mb-[50px] bg-[#fff9f0] bg-[url('/home/home-header.jpg')] bg-cover bg-center bg-no-repeat">
