...
const CartCounterIconButton = ({
  ...
  return (
    <button
      className={twMerge(
        classNames('hidden product-cart lg:flex relative', className),
      )}
    ...
    >
      ...
      {totalUniqueItems > 0 && (
        <span className="min-w-[20px] h-5 flex items-center justify-center rounded-full bg-[#F44535] text-white text-[10px] absolute ltr:-right-1/2 rtl:-left-1/2 -top-1/2">
          {totalUniqueItems}
        </span>
      )}
    </button>
